        ...
        <div v-else v-for="order in paginatedOrders" :key="order.id" class="p-3">
          <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-2 min-w-0">
              <div class="flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-50 dark:bg-emerald-900/30 flex-shrink-0">
                <span class="text-[10px] font-mono font-bold text-emerald-600 dark:text-emerald-400">#{{ order.id.toString().padStart(4, '0') }}</span>
              </div>
              <div class="truncate">
