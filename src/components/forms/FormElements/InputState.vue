<template>
  <div class="space-y-6">
    ...
    <div>
      ...
      <p class="mt-2 text-theme-xs text-error-500">This is an error message.</p>
    </div>
    ...
    <div>
      ...
      <p class="mt-2 text-theme-xs text-success-500">This is a success message.</p>
    </div>

    <!-- Disabled State Input -->
    <div>
      <label class="mb-2 block text-sm font-medium text-gray-300 dark:text-white/15">
        Email
      </label>
      <input
        type="text"
